  ...
  return (
    <header className="sticky top-0 z-10 border-b border-neutral-200 bg-white shadow-card">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-8">
        {/* Logo */}
        <a href="/" className="text-xl font-bold text-neutral-900 hover:text-primary">
          MiniStore
        </a>

        {/* Desktop nav */}
        <nav className="hidden items-center gap-6 sm:flex">
          <a href="/" className="text-sm font-medium text-neutral-700 hover:text-primary">
            Catalog
          </a>
          <a href="/cart" className="text-sm font-medium text-neutral-700 hover:text-primary">
            Cart
          </a>
        </nav>
      ...
      {mobileOpen && (
        <nav className="border-t border-neutral-200 bg-white px-4 py-3 sm:hidden">
          <a href="/" className="block py-2 text-sm font-medium text-neutral-700 hover:text-primary">
            Catalog
          </a>
          <a href="/cart" className="block py-2 text-sm font-medium text-neutral-700 hover:text-primary">
            Cart
          </a>
        </nav>
      )}
